...
export const NetworkLinks = ({className}) => {
    ...
    <Link href='https://www.linkedin.com/in/tanya-pavliuk' className="hover:drop-shadow-[5px_2px_2px_rgba(32,117,110,1)]" >
    ...
    <Link href='https://github.com/Tanyapavliuk' className="hover:drop-shadow-[5px_2px_2px_rgba(32,117,110,1)]">
